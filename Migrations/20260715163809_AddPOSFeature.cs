...
{
    /// <inheritdoc />
    public partial class AddPOSFeature : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_POSSessions_Counters_CounterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CashierId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleDetails_GRNDetails_GRNDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_POSSessions_CounterId",
                table: "POSSessions",
                column: "CounterId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleDetails_GRNDetailId",
                table: "SaleDetails",
                column: "GRNDetailId");
