...
namespace CityMarketPOS.Repositories
{
    public interface IGRNRepository
    {
        ...
        Task ConfirmGRNAndUpdateStockAsync(GRN grn, List<int> productIds, List<int> receivedQtys, List<DateTime?> expiryDates, List<decimal> sellingPrices, List<string> codeTypes, List<string> codePrefixes, List<string> codeValues, int poId);
